...
export default function About() {
  ...
  const organizationSchema = {
    ...
    "logo": "https://medsafeproject.org/logo.png",
    "description": "A grassroots initiative dedicated to medication safety awareness and education.",
    "email": "admin@medsafeproject.org",
  ...
  return (
    <>
      <SEO 
        title="About The MedSafe Project | Our Mission & Team"
        description="Learn about our dedicated team of healthcare professionals and patient advocates working to reduce preventable medication-related harm through education and awareness."
        keywords={["medication safety", "patient advocacy", "healthcare initiative", "adverse drug events", "medication education"]}
